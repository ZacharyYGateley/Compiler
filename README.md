...
Download and run the `zyg_compile.jar` file to start compiling your own code! See below for the usage.

```
com.zygateley.compiler version v0.9.0-rc Copyright Zachary Gateley 2020
