...
public class GoAsm extends AssyLanguage {
	...
	@Override
	public void assembleIntegerOperation(Construct type, Node operand0, Node operand1) throws Exception {
	...
	@Override
	public void assembleOperation(Construct type, Node operand0, Node operand1) throws Exception {
